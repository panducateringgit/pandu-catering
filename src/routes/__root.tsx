...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Delicious, authentic & affordable catering in Hyderabad. South Indian specialty, weddings, corporate, house parties — with doorstep delivery." },
      { name: "theme-color", content: "#6e1d1d" },
      { property: "og:title", content: "Pandu Catering — Best South Indian Catering in Hyderabad" },
      { property: "og:description", content: "Delicious, authentic & affordable catering in Hyderabad. South Indian specialty, weddings, corporate, house parties — with doorstep delivery." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pandu Catering — Best South Indian Catering in Hyderabad" },
      { name: "twitter:description", content: "Delicious, authentic & affordable catering in Hyderabad. South Indian specialty, weddings, corporate, house parties — with doorstep delivery." },
